        ...
        <form onSubmit={handleSubmit} className="card p-5 sm:p-6 mb-6">
            ...
            <div className="space-y-5">
                <div className="grid grid-col-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mmb-2">Name</label>
                        <input
                            disabled
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mmb-2">Email</label>
                        <input
                            disabled
                    ...
                    <div className="sm:col-span-2">
                        <label className="block text-sm font-medium text-slate-700 mmb-2">Position</label>
                        <input
                            disabled
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-700 mmb-2">Bio</label>
                    <textarea
