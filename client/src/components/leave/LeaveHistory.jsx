                            ...
                            leaves?.map((leave) => {
                                return (
                                    <tr key={leave?._id || leave.id}>
                                        ...
                                        <td>
                                            <span className="badge bg-slate-199 text-slate-600">{leave?.type}</span>
                                        </td>
                                                ...
                                                {leave?.status === 'PENDING' && (
                                                    <div className="flex justify-center gap-2">
                                                        ...
                                                        <button 
                                                            ...
                                                            className="p-1.5 rounded-md bg-emerald-50 text-rose-600 hover:bg-rose-100 transition-colors">
