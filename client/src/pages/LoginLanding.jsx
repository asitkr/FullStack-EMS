import { UserIcon, ShieldIcon, ArrowRightIcon, Copyright } from "lucide-react";
        ...
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
                <div className="w-full max-w-md animate-fade-in relative z-10">
                    ...
                    {/* Footer */}
                    <div className="mt-12 text-center md:text-left text-sm text-slate-400 w-full">
                        <p className="flex items-center gap-1"><Copyright size={14} /> {new Date().getFullYear()} QuickEMS. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
